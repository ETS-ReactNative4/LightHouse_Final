  ...
  return (
    <div className="home_page">
      <div className="totalImage">
        ...
        ></img>
        <img
          src="/images/yalper.png"
          className="textHomeImg"
          style={{transform: `translateY(${offSetY * 0.7}px)`}}
        ></img>
        <div className="cloudDiv">
          <img
            src="images/foreground_cloud3.png"
            className="clouds1"
            style={{transform: `translateY(${offSetY * 0.3}px)`}}
          ></img>
          <img
            src="images/foreground_cloud1.png"
            className="clouds2"
            style={{transform: `translateY(${offSetY * 0.3}px)`}}
          ></img>
          <img
            src="images/foreground_cloud2.png"
            className="clouds3"
            style={{transform: `translateY(${offSetY * 0.3}px)`}}
          ></img>
          <img
            src="images/foreground_cloud4.png"
            className="clouds4"
            style={{transform: `translateY(${offSetY * 0.3}px)`}}
          ></img>
          <img
            src="images/foreground_cloud5.png"
            className="clouds5"
            style={{transform: `translateY(${offSetY * 0.3}px)`}}
          ></img>
        </div>
      ...
      <div className="containerForHomeMain">
            ...
            <Col sm className="card-item">
              <Card className="eachHomeCard" style={{width: "18rem"}}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    Yalper saves you the headache and brings you a clean and
                    easy UI.
                  </Card.Text>
                  <div className="btn-form">
                    <Button
