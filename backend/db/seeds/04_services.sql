...
VALUES
    ...
    ('Treeflex', 'Inverse', 91, 1488572583, 1478893633, 2),
    ('Wrapsafe', 'regional', 58, 1512092610, 1433561870, 7),
    ('Andalax', 'Persistent', 95, 1479531940, 1469729187, 4),
    ('Bamity', 'Multi-lateral', 6, 1491221115, 1450592729, 6),
    ('Andalax', 'asymmetric', 25, 1425111498, 1424488701, 2);
